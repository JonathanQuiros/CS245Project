...
public class PlayHangman extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        timeDisplay = new java.awt.TextField();
        ...
        timeDisplay.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
            ...
            public void run(){
                try{
                    while(true){
                        ...
                        timeDisplay.setText((month + 1) + "/" + day + "/" + year + "  " + hour + ":" + minute + ":" + second);
                        sleep(1000);
                    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new PlayHangman().setVisible(true);
            }
        });
    }
    ...
    //Change this to transition to score screen instead of exiting
    ...
    private java.awt.TextField timeDisplay;
